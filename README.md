...
![](https://user-images.githubusercontent.com/188244/46820467-d8379d00-cdb8-11e8-8ca0-64e8fd1b73d5.gif)
...
如果要查看当前变量，在左侧终端内输入 `repl`，输入变量名字即可查看。需要退出 Repl 模式才能继续逐行跟踪，输入 <kbd>Ctrl-C</kbd> 退出 Repl 模式。
